...
const StakeholderForm = ({ onNavigate, subItem }) => {
  ...
  // States for search and update functionality
...
// Effect for fetching pending requests
useEffect(() => {
  if (subItem === 'Pending') {
            ...
            {selectedRequest && (
              ...
              >
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: 20 }}
                  className="bg-white rounded-xl shadow-lg max-w-3xl w-full mx-4 max-h-[90vh] overflow-y-auto p-6"
                >
                  <div className="flex justify-between items-center mb-6">
                    <h2 className="text-xl font-semibold text-gray-800">Update Request</h2>
                    <button
                  ...
                  <form onSubmit={handleUpdate} className="space-y-6">
                    {/* Same form fields as update form above */}
                    {/* ... */}
                    <div className="flex justify-end space-x-3">
                      <button
                        type="button"
